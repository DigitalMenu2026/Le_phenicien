    ...
    if (bookingForm) {
        bookingForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                alert(`🎉 RÉSERVATION CONFIRMÉE !\n\nTable : ${formData.table_selected}\nNom : ${formData.full_name}\nDate : ${formData.res_date}\nHeure : ${formData.res_time}`);
                ...
                // Recharger immédiatement les tables pour que la table passe en ROUGE instantanément
